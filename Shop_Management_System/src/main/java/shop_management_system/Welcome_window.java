...
public class Welcome_window extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Shop Manangement System");

        jLabel3.setIcon(new javax.swing.ImageIcon("E:\\Shop_Management_System\\src\\main\\java\\shop_management_system\\shop.png")); // NOI18N

        jButton1.setBackground(new java.awt.Color(153, 153, 255));
        jButton1.setText("Click To Advance");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
           public void run() {
                new Welcom_loading().setVisible(true);
            }
        });       
